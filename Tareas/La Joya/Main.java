                    ...
                    if (mata.matches()) {
                        ...
                        case 2:
                            ...
                            for (Criminal elemento : celda) {
                                final PrintStream printf = System.out.printf("%s\ncedula: %s\ndetenido por %s\nCapturado por el %s %s%n", +elemento.getNombre(), elemento.getCedula(), elemento.getDelito(), elemento.getRango(), elemento.getPolicia());
                            }
                            break;
                        case 3:
                            break;
